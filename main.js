var rules = [
    ...
    'ეს თამაში ყველაზე მარტივად და სწრაფად შეგაზარხოშებთ 🥴 თამაშის წესები მარტივია: რიგრიგობით გახსენით ახალი კარტი და შეასრულეთ მასზე დაწერილი პირობები! ',
...
var ivenever = [
    ...
    'მიჩხუბია რიგის გამო',
    'დამიწყევლია ვინმე ',
    'შემიჭრია მთვრალზე თმები 💇‍♀️',
    'ამიცდენია დენცქვიტასთვის შესაერთებელი',
    'მომისაქმებია ბუნებაში ',
    'ჩამიფსამს აუზში ',
    'მქონია სექსი 20 წუთზე დიდხანს',
    'მომიგონებია ტყუილი ჩემი ცუდი საქციელის გადასაფარად',
    ...
    'ცხვირში თითის ბზრიალს ძალიან არ შევუყოლებივარ',
    'მისრიალია თხილამურებით ⛷️',
    ...
    'მიცურავია აუზში ან ზღვაში შიშველს ',
    'მიჭამია ძირს დაგდებული საჭმელი',
    'ჩამძინებია ავტობუსში და გამომიტოვებია ჩემი გაჩერება',
    'დავქრაშულვარ ჩემს ნათესავზე ',
    'გავუქურდივარ ',
    'გავჭედილვარ ლიფტში',
    'მიჭამია უცნობი ადამიანის დატოვებული საჭმელი ',
    'მიყვირია გოგიტა გლდანის შაურმის რიგში',
    'დამილევია მაგიდაზე დაქცეული სასმელი',
    'დამჯახებია მანქანა',
    'მიტირია უმიზეზოდ ',
    'გამიყალბებია საბუთი',
    'გამღვიძებია უცნობი ადამიანის გვერდით',
    'ვყოფილვარ სასწრაფოს მანქანაში',
    'გამიგზავნია ნუდები',
    'შევსულვარ საპირისპირო სქესისთვის განკუთვნილ ტუალეტში',
    'ჩამიგდია ტუალეტში მობილური',
    'მიცდია მეეჭვიანებინა შეყვარებული 🧛‍♀️',
    'გამოვუგდივარ სამსახურიდან',
    'გადამიმოწმებია ყოფილი შეყვარებულის სოციალური მედია',
    'მომიპარავს ოფისიდან ნივთი',
    'გადამიღია ტიკ ტოკი',
    'მომიპარავს 10 ლარზე მეტი ღირებულების ნივთი',
    'დამიდია ფსონი თამაშზე',
    'გამღვიძებია მთვრალს სმის მეორე დღეს',
    'გადამიტანია საზღვარზე რამე არალეგალური',
    'ვყოფილვარ ლაშქრობაში',
    'ვყოფილვარ სანადიროდ',
    'მისვრია იარაღი',
    'ვყოფილვარ კაზინოში',
    'გადმოვმხტარვარ სახურავიდან',
...
$(document).ready(function(){
    ...
    $(".text-content .main-button").click(function(){
        gtag('event', 'page_view', {
            ...
            page_path: '/choosegames',
            send_to: 'G-VPQHD24GV4'
          });
    ...
    $("body").on("click"," .other-games, .go-back, .logo", function(){
        ...
        if($("body").hasClass('select-games')) return;
        gtag('event', 'page_view', {
            page_title: 'თამაშების არჩევა',
            page_location: '/choosegames',
            page_path: '/choosegames',
